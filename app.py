...
def predict():
    if request.method == 'POST':
        ...
        val0, val1, val2, val3, val4, val5, val6, val7 = str(request.form['0']),float(request.form['1']), float(request.form['2']), float(request.form['3']), float(request.form['4']), float(request.form['5']), float(request.form['6']), float(request.form['7'])
        final4 = np.array([val1,val2,val3,val4,val5,val6,val7]).reshape(1,-1)
